...
const DownloadExcelRaspFile = () => {
  const handleDownload = async () => {
    try {
      const response = await axios.get('/api/download_file', {
      ...
      link.href = url;
      link.setAttribute('download', 'schedule_ck.xlsx'); // Укажите имя файла здесь
...
export default DownloadExcelRaspFile;
